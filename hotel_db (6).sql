...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 01 mai 2024 à 18:50
...
-- Procédures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `delete_old_reservations` ()   BEGIN
  DELETE FROM room_reservee
...
(31, 'admin', 'akamichoyo123'),
(32, 'mayalla', 'aaaaaaaaaaaaaaaaaaaaaaaaa'),
(33, 'salim', 'a3333333333');
...
CREATE TABLE `comment` (
  ...
  `comment_text` varchar(32767) NOT NULL,
...
INSERT INTO `comment` (`id`, `hotel_id`, `user_id`, `comment_text`, `date_comment`, `note`) VALUES
(1, 2, 9, 'Modern luxury meets natural beauty. Nestled by a tranquil lake and majestic mountains, our elegant retreat offers exquisite rooms with stunning views. Indulge in gourmet dining, outdoor adventures, and rejuvenating spa treatments. Escape to a world of tra', '2024-03-19', 10),
(30, 2, 9, 'aaaaaaaaaaaaaaaaaa', '2024-03-22', 10),
(31, 2, 9, 'Akamichoyo1', '2024-03-22', 10),
(32, 2, 9, 'Akamichoyo1', '2024-03-22', 10),
(33, 2, 9, '', '2024-03-22', 10),
(34, 2, 9, 'ASDFGHJKL', '2024-03-22', 10),
(38, 3, 5, '', '2024-03-13', 6);
...
--
DELIMITER $$
CREATE TRIGGER `decrement_nbrcomment` AFTER DELETE ON `comment` FOR EACH ROW BEGIN
    UPDATE hotel
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `update_nbrcomment` AFTER INSERT ON `comment` FOR EACH ROW BEGIN
    UPDATE hotel
    SET nbrcomment = nbrcomment + 1
...
INSERT INTO `countries` (`countries_id`, `name`, `phonecode`) VALUES
(1, 'Afghanistan', 93),
(2, 'Albania', 355),
(3, 'Algeria', 213),
...
INSERT INTO `devise` (`id`, `name`, `value`, `sign`) VALUES
(1, 'DZD', 134.59, 'DA'),
(2, 'USD', 1, '$'),
(3, 'EUR', 0.92, '€'),
(5, 'GBP', 0.72, '£');
...
CREATE TABLE `hotel` (
  ...
  `nbrcomment` int(11) DEFAULT NULL,
  `nbrstar` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `hotel` (`id`, `name`, `adresse`, `phone`, `email`, `countries_id`, `id_state`, `nbrcomment`, `nbrstar`) VALUES
(2, 'Grand Prince Hotel Shin Takanawa', '3-chome-13-1 Takanawa, Minato City, Tokyo 108-8612, Japon', '+81 3-3442-1111', '', 109, 1959, 6, 5),
(3, 'The Royal Park Hotel Iconic Tokyo Shiodome', '1-chome-6-3 Higashishinbashi, Minato City, Tokyo 105-8333, Japon', '+81 3-6253-1111', '', 109, 1959, 1, 4),
(4, 'Hotel JAL City Tokyo Toyosu', '6-chome-4-20 Toyosu, Koto City, Tokyo 135-0061, Japon', '+81 3-5962-4000', '', 109, 1959, 1, 4),
(27, 'Maya Alla', '302 rue hamid gabladj', '+213667279512', 'razanmaya44@gmail.com', 109, 1959, NULL, 3),
(28, 'Maya Alla', '302 rue hamid gabladj', '+213667279510', 'mayaalla623@gmail.com', 109, 1959, NULL, 4);

-- --------------------------------------------------------

--
-- Doublure de structure pour la vue `hotel_average_notes`
-- (Voir ci-dessous la vue réelle)
--
CREATE TABLE `hotel_average_notes` (
`hotel_id` int(11)
,`hotel_name` varchar(255)
,`average_note` decimal(12,1)
);

-- --------------------------------------------------------

--
-- Doublure de structure pour la vue `hotel_average_notes_int`
-- (Voir ci-dessous la vue réelle)
--
CREATE TABLE `hotel_average_notes_int` (
`hotel_id` int(11)
,`hotel_name` varchar(255)
,`average_note` decimal(11,0)
);
...
INSERT INTO `hotel_images` (`id`, `hotel_id`, `url`) VALUES
(1, 2, '148118255.jpg'),
(2, 2, '180287902.jpg'),
(3, 2, '75752171.jpg'),
(4, 3, '57903161.jpg\r\n'),
...
(11, 4, '472324916.jpg'),
(12, 4, '472324895.jpg'),
(38, 27, 'Default_Capture_a_spacious_lightfilled_modern_loft_in_a_photor_2.jpg'),
(40, 27, 'Anime_Pastel_Dream_A_captivating_fantasy_art_style_illustratio_0.jpg'),
(41, 27, 'Anime_Pastel_Dream_A_captivating_fantasy_art_style_illustratio_1 (1).jpg'),
(42, 27, 'Anime_Pastel_Dream_A_captivating_fantasy_art_style_illustratio_1.jpg'),
(43, 27, 'Anime_Pastel_Dream_A_dimly_lit_hallway_with_crumbling_walls_an_0.jpg'),
(44, 27, 'Anime_Pastel_Dream_A_dimly_lit_hallway_with_crumbling_walls_an_2.jpg'),
(45, 27, 'Anime_Pastel_Dream_A_dimly_lit_hallway_with_crumbling_walls_an_3.jpg'),
(46, 27, 'Anime_Pastel_Dream_A_dreamlike_illustration_of_a_luminous_fore_1.jpg'),
(47, 27, 'Anime_Pastel_Dream_A_dreamlike_illustration_of_a_luminous_fore_3.jpg'),
(48, 27, 'Anime_Pastel_Dream_A_fantastical_space_city_floating_in_the_vo_1.jpg'),
(49, 27, 'Anime_Pastel_Dream_A_fantastical_space_city_floating_in_the_vo_2 (1).jpg'),
(50, 27, 'Anime_Pastel_Dream_A_fantastical_space_city_floating_in_the_vo_2.jpg'),
(51, 27, 'Anime_Pastel_Dream_A_fantastical_space_city_floating_in_the_vo_3.jpg'),
(52, 27, 'Anime_Pastel_Dream_A_lone_astronaut_drifts_in_the_cosmic_void_0.jpg'),
(53, 27, 'Anime_Pastel_Dream_A_lone_astronaut_drifts_in_the_cosmic_void_1 (1).jpg'),
(54, 27, 'Anime_Pastel_Dream_A_lone_astronaut_drifts_in_the_cosmic_void_1.jpg'),
(55, 27, 'Anime_Pastel_Dream_A_lone_astronaut_drifts_in_the_cosmic_void_2 (1).jpg'),
(56, 27, 'Anime_Pastel_Dream_A_lone_astronaut_drifts_in_the_cosmic_void_3.jpg'),
(57, 27, 'Anime_Pastel_Dream_A_magical_fantasy_art_style_illustration_of_0.jpg'),
(58, 27, 'Anime_Pastel_Dream_A_magical_fantasy_art_style_illustration_of_1.jpg'),
(59, 27, 'Anime_Pastel_Dream_A_magical_fantasy_art_style_illustration_of_3.jpg');

-- --------------------------------------------------------

--
-- Structure de la table `hotel_option`
--

CREATE TABLE `hotel_option` (
  `option_name` varchar(511) NOT NULL,
  `hotel_id` int(11) NOT NULL,
  `price` int(255) DEFAULT 100
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Déchargement des données de la table `hotel_option`
--

INSERT INTO `hotel_option` (`option_name`, `hotel_id`, `price`) VALUES
('24H/7D front desk', 27, 220),
('Air conditioning', 2, NULL),
('Air conditioning', 27, 451),
('Breakfast available', 2, NULL),
('Business services', 2, NULL),
('Free WiFi', 2, NULL),
('Free WiFi', 3, NULL),
('Free WiFi', 4, NULL),
('Free WiFi', 27, 220),
...
--
-- Déchargement des données de la table `iframe`
--

INSERT INTO `iframe` (`id`, `hotel_id`, `url`) VALUES
(1, 2, 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3242.90712554831!2d139.73090297463406!3d35.63001603278759!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188a56edbf1743%3A0xfa8070ee18669bb5!2sGrand%20Prince%20Hotel%20Shin%20Takanawa!5e0!3m2!1sfr!2sdz!4v1710450685912!5m2!1sfr!2sdz'),
(2, 3, 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3241.542092941405!2d139.75741857463584!3d35.6636518809414!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188bc2f32d3b79%3A0xaa86132116d2feba!2sThe%20Royal%20Park%20Tokyo%20Shiodome!5e0!3m2!1sfr!'),
(3, 4, 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3242.2216112358124!2d139.78419227578624!3d35.6469112725984!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188990871d87db%3A0x788069efdb55baf5!2sHotel%20JAL%20City%20Tokyo%20Toyosu!5e0!3m2!1sfr!2sdz!4v1711488884950!5m2!1sfr!2sdz');

-- --------------------------------------------------------

--
-- Structure de la table `mailcode`
--
...
--
-- Doublure de structure pour la vue `min_price_per_hotel`
-- (Voir ci-dessous la vue réelle)
--
CREATE TABLE `min_price_per_hotel` (
`hotel_id` int(11)
,`hotel_name` varchar(255)
,`min_price` int(11)
);
...
INSERT INTO `option` (`name`, `type`) VALUES
('24H/7D front desk', 'H'),
('Air conditioning', 'HR'),
('Baby cots', 'R'),
('Baby-sitting', 'R'),
('Babysitting', 'H'),
('Breakfast available', 'HR'),
('Business services', 'H'),
('Chambres insonorisées', 'R'),
('Cour de tennis', 'H'),
('Free WiFi', 'HR'),
('Gym', 'H'),
('Housekeeping', 'HR'),
('Laundry', 'H'),
('Lits/lits pour enfants supplémentaires', 'R'),
('Outdoor space', 'H'),
('Parking available', 'H'),
('Phone', 'R'),
('Piscine pour enfants', 'H'),
('Plage privée', 'H'),
('Pool', 'H'),
('Restaurant', 'H'),
('Room service', 'HR'),
('Salle de jeux', 'H'),
('Salon/salle à manger', 'R'),
('Spa', 'H'),
('Tv', 'R');
...
INSERT INTO `partner` (`id`, `first_name`, `last_name`, `email`, `password`, `username`, `phone`) VALUES
(3, 'Maya', 'Alla', 'mayamiya313@gmail.com', '$2y$10$fKGaLfwatgTyAM/xvXLozOMlvLrKW4P.IlWQB5Rwln/wMbU0xj4p2', 'serineaitalia', '213667279510');

-- --------------------------------------------------------

--
-- Structure de la table `partnerhotel`
--
...
--
-- Déchargement des données de la table `partnerhotel`
--

INSERT INTO `partnerhotel` (`id`, `partner_id`, `hotel_id`) VALUES
(21, 3, 27),
(22, 3, 27);
...
INSERT INTO `reservation` (`id`, `user_id`, `room_id`, `date_debut`, `date_fin`, `nbr_person`, `status`, `hotel_id`, `Total_price`, `nbr_child`, `reservation_date`) VALUES
(22, 9, 9, '2024-03-10', '2024-03-15', 2, 'Confirmer', 2, 1432, 1, '2024-03-23'),
(23, 9, 13, '2024-03-20', '2024-03-23', 1, 'Confirmer', 2, 1432, 1, '2024-03-23'),
(24, 9, 12, '2024-03-01', '2024-03-31', 1, 'Annuler', 2, 1234, 1, '2024-03-23'),
(25, NULL, 9, '2024-03-25', '2024-04-25', 1, 'Confirmer', 2, 5516, 1, '2024-03-24'),
(26, NULL, 9, '2024-03-25', '2024-04-25', 1, 'Confirmer', 2, 5516, 1, '2024-03-24'),
(27, NULL, 9, '2024-03-25', '2024-04-25', 1, 'Confirmer', 2, 5516, 1, '2024-03-24'),
(28, NULL, 8, '2024-03-25', '2024-04-25', 1, 'Confirmer', 3, 11158, 1, '2024-03-24'),
(31, 9, 9, '2024-03-24', '2024-03-20', 1, 'Confirmer', 2, 764, 1, '2024-03-24'),
(32, 9, 9, '2024-03-24', '2024-03-20', 1, 'Confirmer', 2, 764, 1, '2024-03-24'),
(33, 9, 9, '2024-03-29', '2024-03-31', 1, 'Confirmer', 2, 412, 1, '2024-03-29');

--
-- Déclencheurs `reservation`
--
DELIMITER $$
CREATE TRIGGER `insert_reserved_room` AFTER INSERT ON `reservation` FOR EACH ROW BEGIN
  INSERT INTO `room_reservee`(`room_id`, `hotel_id`, `reservation_id`, `date_dbt`, `date_fin`) 
  VALUE (NEW.`room_id`, NEW.`hotel_id`, NEW.`id`, NEW.`date_debut`, NEW.`date_fin`);
END
$$
DELIMITER ;
...
CREATE TABLE `room` (
  ...
  `bednbr` int(11) DEFAULT NULL,
  `bedtype` varchar(511) DEFAULT NULL,
...
INSERT INTO `room` (`id`, `hotel_id`, `price`, `capacity`, `bednbr`, `bedtype`, `size`, `type`) VALUES
(8, 3, 358, 2, 1, '1 large double bed', 20, 'Economy Double Room with Tokyo Tower View'),
(9, 2, 176, 2, 2, '2 single beds', 30, 'Superior Twin Room - Non-Smoking'),
(10, 4, 404, 2, 2, '2 single beds\r\n', 25, 'Chambre à lits jumeaux moyenne – Non-fumeurs'),
(11, 2, 176, 2, 2, '2 single beds', 25, 'Superior Twin Room - Non-Smoking'),
(12, 2, 176, 2, 2, '2 single beds', 25, 'Superior Twin Room - Non-Smoking'),
(13, 2, 176, 2, 2, '2 single beds', 25, 'Superior Twin Room - Non-Smoking'),
(28, 27, 270, 1, 2, 'single bed', 20, 'chombra with alger'),
(29, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(31, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(32, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(33, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(34, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(35, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(36, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(37, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(38, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(39, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(40, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(41, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(42, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(43, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(45, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(47, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(48, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(49, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(50, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(51, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(52, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(54, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(55, 27, 280, 30, 2, 'sigle bed', 20, 'chombra'),
(57, 27, 280, 30, 2, 'sigle bed', 20, 'chombra');
...
INSERT INTO `room_images` (`id`, `room_id`, `hotel_id`, `url`) VALUES
(1, 8, 3, 'photo_6023835351291903952_y.jpg'),
(2, 8, 3, 'photo_6023835351291903951_x.jpg'),
(3, 8, 3, 'photo_6023835351291903950_y.jpg'),
(4, 9, 2, 'room1.PNG'),
(5, 9, 2, 'room2.PNG'),
(6, 9, 2, 'room3.PNG'),
(7, 10, 2, 'room1.PNG'),
...
(17, 13, 2, 'room2.PNG'),
(18, 13, 2, 'room3.PNG'),
(35, 57, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(37, 55, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(38, 54, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(40, 52, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(41, 51, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(42, 50, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(43, 49, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(44, 48, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(45, 47, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(47, 45, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(49, 43, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(50, 42, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(51, 41, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(52, 40, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(53, 39, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(54, 38, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(55, 37, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(56, 36, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(57, 35, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(58, 34, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(59, 33, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(60, 32, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(61, 31, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(63, 29, 27, 'Anime_Pastel_Dream_Progressive_visualization_The_breathtaking_3 (5).jpg'),
(73, 28, 27, 'yufwefoqu.PNG');

-- --------------------------------------------------------

--
-- Structure de la table `room_occupe`
--
...
INSERT INTO `room_option` (`name`, `room_id`, `hotel_id`, `price`) VALUES
('Free WiFi', 9, 2, NULL),
('Free WiFi', 10, 2, NULL),
('Free WiFi', 11, 2, NULL),
('Free WiFi', 12, 2, NULL),
('Free WiFi', 13, 2, NULL),
('Air conditioning', 9, 2, NULL),
('Air conditioning', 11, 2, NULL),
('Air conditioning', 12, 2, NULL),
('Air conditioning', 13, 2, NULL),
('Air conditioning', 10, 2, NULL),
('Baby-sitting', 9, 2, NULL),
('Tv', 9, 2, NULL),
('Phone', 9, 2, NULL),
('Baby cots', 28, 27, 56),
('Baby cots', 29, 27, 666),
('24H/7D front desk', 28, 27, 444);

-- --------------------------------------------------------

--
-- Structure de la table `room_reservee`
--

CREATE TABLE `room_reservee` (
  `hotel_id` int(11) NOT NULL,
  `room_id` int(11) NOT NULL,
  `reservation_id` int(11) NOT NULL,
  `date_dbt` date DEFAULT NULL,
...
INSERT INTO `states` (`id_state`, `name`, `countries_id`) VALUES
...
--
-- Structure de la table `total_price`
--
...
INSERT INTO `user` (`id`, `username`, `name`, `age`, `prename`, `password`, `email`, `phone`, `pays`, `image`) VALUES
(5, 'mayaalla', 'maya', 12, 'Maya', '$2y$10$0wQ8Hw9.9K0LMQ0LHQfHf.rj1ksY8Sj.km3ek5D63VXMUVGQjwVGC', 'razanmaya44@gmail.com', '+213667279510', 'Algeria', 'Anime_Pastel_Dream_acrylic_painting_on_canvas_simple_brush_str_3.jpg'),
(6, 'a33', 'maya', 21, 'Alla', '$2y$10$IJY06eaxCCeU2nXb4hvVqeAkZJIrBSaiLxZum3A/.R31nWTsaA67q', 'mayaalla623@gmail.com', '+213667279518', 'Algeria', 'tw7qeyofiu.PNG'),
(9, 'admin111', 'Alla', 22, 'Maya', '$2y$10$/vSd2Ic9UlsPXTJzbdbeUuByvyLnWsqcYzvuNgRL.yrDCu9hhyGdq', 'mayaalla888@gmail.com', '+213667279515', 'Algeria', 'replicate-prediction-gkv5strbhkdss2pt5fk46ckere (1).png'),
(16, 'serineaitalia', 'AIT ALIA', 19, 'Serine', '$2y$10$8aY1.IESHTl7W2uh/VDEze8D8NGzbQoTrG8QUnaaiSiGJ7jcIjPfK', 'mayamiya313@gmail.com', ' 213667279510', 'Algeria', '');

-- --------------------------------------------------------

--
-- Structure de la vue `hotel_average_notes`
--
DROP TABLE IF EXISTS `hotel_average_notes`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `hotel_average_notes`  AS SELECT `h`.`id` AS `hotel_id`, `h`.`name` AS `hotel_name`, round(avg(`c`.`note`),1) AS `average_note` FROM (`hotel` `h` left join `comment` `c` on(`h`.`id` = `c`.`hotel_id`)) GROUP BY `h`.`id`, `h`.`name` ;

-- --------------------------------------------------------

--
-- Structure de la vue `hotel_average_notes_int`
--
DROP TABLE IF EXISTS `hotel_average_notes_int`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `hotel_average_notes_int`  AS SELECT `h`.`id` AS `hotel_id`, `h`.`name` AS `hotel_name`, round(avg(`c`.`note`),0) AS `average_note` FROM (`hotel` `h` left join `comment` `c` on(`h`.`id` = `c`.`hotel_id`)) GROUP BY `h`.`id`, `h`.`name` ;

-- --------------------------------------------------------

--
-- Structure de la vue `min_price_per_hotel`
--
DROP TABLE IF EXISTS `min_price_per_hotel`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `min_price_per_hotel`  AS SELECT `h`.`id` AS `hotel_id`, `h`.`name` AS `hotel_name`, min(`r`.`price`) AS `min_price` FROM (`hotel` `h` left join `room` `r` on(`h`.`id` = `r`.`hotel_id`)) GROUP BY `h`.`id`, `h`.`name` ;
...
--
-- Index pour la table `hotel_option`
--
ALTER TABLE `hotel_option`
  ADD PRIMARY KEY (`option_name`,`hotel_id`),
  ADD KEY `hotel_id` (`hotel_id`);

--
-- Index pour la table `iframe`
--
ALTER TABLE `iframe`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `partnerhotel`
--
ALTER TABLE `partnerhotel`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `room_images`
  ADD PRIMARY KEY (`id`,`room_id`,`hotel_id`),
  ADD KEY `room_id` (`room_id`),
  ADD KEY `hotel` (`hotel_id`);

--
-- Index pour la table `room_occupe`
--
ALTER TABLE `room_occupe`
  ADD PRIMARY KEY (`id`),
  ADD KEY `room_id` (`room_id`);

--
-- Index pour la table `room_option`
--
ALTER TABLE `room_option`
  ADD KEY `room_option_ibfk_1` (`room_id`),
  ADD KEY `room_option_ibfk_2` (`name`),
  ADD KEY `room_option_ibfk_3` (`hotel_id`);

--
-- Index pour la table `room_reservee`
--
ALTER TABLE `room_reservee`
  ADD PRIMARY KEY (`hotel_id`,`room_id`,`reservation_id`),
...
--
-- Index pour la table `total_price`
--
...
--
-- AUTO_INCREMENT pour la table `iframe`
--
ALTER TABLE `iframe`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `mailcode`
--
ALTER TABLE `mailcode`
...
--
-- AUTO_INCREMENT pour la table `partnerhotel`
--
ALTER TABLE `partnerhotel`
...
--
-- AUTO_INCREMENT pour la table `room_occupe`
--
ALTER TABLE `room_occupe`
...
--
-- AUTO_INCREMENT pour la table `total_price`
--
ALTER TABLE `total_price`
...
ALTER TABLE `comment`
  ...
  ADD CONSTRAINT `comment_ibfk_2` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `hotel`
--
ALTER TABLE `hotel`
  ADD CONSTRAINT `hotel_ibfk_1` FOREIGN KEY (`countries_id`) REFERENCES `countries` (`countries_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `hotel_ibfk_2` FOREIGN KEY (`id_state`) REFERENCES `states` (`id_state`) ON DELETE CASCADE;

--
-- Contraintes pour la table `hotel_images`
--
ALTER TABLE `hotel_images`
  ADD CONSTRAINT `hotel_images_ibfk_1` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `hotel_option`
--
ALTER TABLE `hotel_option`
  ADD CONSTRAINT `hotel_option_ibfk_1` FOREIGN KEY (`option_name`) REFERENCES `option` (`name`) ON DELETE CASCADE,
  ADD CONSTRAINT `hotel_option_ibfk_2` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `iframe`
--
ALTER TABLE `iframe`
  ADD CONSTRAINT `iframe_ibfk_1` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `partnerhotel`
--
ALTER TABLE `partnerhotel`
  ADD CONSTRAINT `partnerhotel_ibfk_1` FOREIGN KEY (`partner_id`) REFERENCES `partner` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `partnerhotel_ibfk_2` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `reservation`
  ...
  ADD CONSTRAINT `reservation_ibfk_4` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `room`
--
ALTER TABLE `room`
  ADD CONSTRAINT `room_ibfk_2` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `room_images`
--
ALTER TABLE `room_images`
  ADD CONSTRAINT `room_images_ibfk_1` FOREIGN KEY (`room_id`) REFERENCES `room` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `room_images_ibfk_2` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `room_occupe`
--
ALTER TABLE `room_occupe`
  ADD CONSTRAINT `room_occupe_ibfk_1` FOREIGN KEY (`room_id`) REFERENCES `room` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `room_option`
--
ALTER TABLE `room_option`
  ADD CONSTRAINT `room_option_ibfk_1` FOREIGN KEY (`room_id`) REFERENCES `room` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `room_option_ibfk_2` FOREIGN KEY (`name`) REFERENCES `option` (`name`) ON DELETE CASCADE,
  ADD CONSTRAINT `room_option_ibfk_3` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `room_reservee`
--
ALTER TABLE `room_reservee`
  ADD CONSTRAINT `room_reservee_ibfk_1` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `room_reservee_ibfk_2` FOREIGN KEY (`room_id`) REFERENCES `room` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `room_reservee_ibfk_3` FOREIGN KEY (`reservation_id`) REFERENCES `reservation` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `states`
--
ALTER TABLE `states`
  ADD CONSTRAINT `states_ibfk_1` FOREIGN KEY (`countries_id`) REFERENCES `countries` (`countries_id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `total_price`
--
ALTER TABLE `total_price`
  ADD CONSTRAINT `total_price_ibfk_1` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`)  ON DELETE CASCADE;

DELIMITER $$
--
-- Évènements
--
CREATE DEFINER=`root`@`localhost` EVENT `delete_expired_reservations` ON SCHEDULE EVERY 1 SECOND STARTS '2024-03-12 17:23:33' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
  DELETE FROM `room_reservee` WHERE `date_fin` < CURRENT_DATE();
END$$
...
--  recreat room_occupe, ajout hotel_id
drop table room_occupe;
